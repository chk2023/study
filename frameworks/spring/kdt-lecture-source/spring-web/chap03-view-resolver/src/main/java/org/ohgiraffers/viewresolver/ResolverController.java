...
public class ResolverController {
    ...
    public String stringReturning(Model model) {
        ...
        // prefix는 tempaltes, suffix는 .html -> 이 둘을 뺀 나머지 내용을 작성.
        return "result";
    }
    ...
    public String stringRedirectFlashAttribute(RedirectAttributes rttr) {
        ...
        /* redirect 처리 시 request scope의 데이터는 공유되지 않는다.
        * session scope에 너무 많은 데이터를 저장하는 것은 서버 성능에 영향을 준다.
        * redirect 처리 시 전달하여 잠깐 사용하고 싶은 데이터가 있다면 (Ex. 저장완료 alert 메시지 등)
        * RedirectAttributes 객체를 통해 잠시 세션에 저장했다가 redirect 후 세션에서 제거되게 할 수 있다. */
    ...
    public ModelAndView modelAndViewFlashAttribute(ModelAndView mv, RedirectAttributes rttr) {
