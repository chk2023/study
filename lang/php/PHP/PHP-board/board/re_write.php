...
<body>
    ...
    <form method="POST" action="re_write_action.php" >

    <input type="hidden" name="idx" value=<?=$_GET['idx']?>> <br>
    <input type="hidden" name="ref" value=<?=$_GET['ref']?>><br>
    <input type="hidden" name="re_step" value=<?=$_GET['re_step']?>><br>
    <input type="hidden" name="re_level" value=<?=$_GET['re_level']?>><br>
​
