...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 참조 자료형(reference type)이라고 한다.*/
        //iarr = new int[5];  //할당할 크기는 반드시 지정 되어야 한다.
        iarr = new int[5];
        darr = new double[10];
        ...
        * stack에 저장된 주소로 heap에 할당된 배열을 찾아갈 수 있다. */
        ...
        /* hasCode() : 객체의 주소 값을 10진수로 변환하여 생성한 객체의 고유한 정수 값을 반환하는 메소드 */
        System.out.println("iarr2 : " + iarr2.hashCode());
        System.out.println("darr2 : " + darr2.hashCode());
        ...
        * 새로운 배열을 생성하여 그 주소 값을 레퍼런스 변수에 덮어쓴다. */
        ...
        /* 한 번 할당된 배열은 지울 수 없다.
        * 단, 참조되지 않는 배열은 일정 시간이 지난 후 heap의 old 영역으로 이동하여 GC가 삭제한다.
        * 한번 찾아 갈 수 있는 주소 값을 잃어버린 배열은 다시 참조 불가능하다. */
