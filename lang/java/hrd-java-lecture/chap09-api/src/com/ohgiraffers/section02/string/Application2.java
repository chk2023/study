...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 리터럴 형태로 만든 문자열 인스턴스는 동일한 값을 가지는 인스턴를 하나의 인스턴스로 관리한다.
        * 따라서 주소 값을 비교하는 == 연산으로 비교시 true를 반환한다. */
        System.out.println("str1 == str2 : " + (str1 == str2));
        /* new로 새로운 인스턴스를 생성하게 되면 기본 인스턴스를 두고 새로운 인스턴스를 할당하기 때문에
        ...
        * */
        ...
        /* equals() : 인스턴스 주소 값 비교가 아니라 문자열 값을 비교하여 동일한 값을 가지면 true를 반환하도록
