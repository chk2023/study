...
public class Application4 {
    public static void main(String[] args) {
        ...
        MemberDTO[] outputMembers = {
                new MemberDTO("user01", "pass01", "홍길동",
                        "hong123@ohgiraffers.com", 25, '남',1235.7),
                new MemberDTO("user02", "pass02", "유관순",
                        "yoo123@ohgiraffers.com", 16, '여',1250.7),
                new MemberDTO("user03", "pass03", "이순신",
                        "lee123@ohgiraffers.com", 40, '남',1270.7)
        };
        ...
        * */
        ...
        try (ObjectInputStream objIn = new ObjectInputStream(new FileInputStream("testObjectStream.txt"))) {
            ...
            * ClassNotFoundException 핸들링 필요하다. */
