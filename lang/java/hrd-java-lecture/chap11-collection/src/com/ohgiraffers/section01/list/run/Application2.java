...
import com.ohgiraffers.section01.list.list.dto.BookDTO;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        bookList.add(new BookDTO(1, "목민심서", "정약용", 30000));
        bookList.add(new BookDTO(1, "동의보감", "허준", 40000));
        bookList.add(new BookDTO(1, "삼국사기", "김부식", 46000));
        bookList.add(new BookDTO(1, "삼국유사", "일연", 58000));
