...
public class Application4 {
    public static void main(String[] args) {
        ...
        /* 4. 2가지 이상의 DML이 하나의 논리적인 단위(트랜잭션으로 묶일 경우
        * 모든 동작이 정상 수행 되었을 때 commit, 일부 동작이 비정상 수행 되었을 때 rollback으로 처리 하여
        * 트랜잭션을 제어한다. */
        ...
        try {
            ...
            pstmt2.setInt(3, 0); //삽입 오류가 발생하도록 존재하지 않는 category code로 입력
