...
public class CalculatorTests {
    ...
    /* 테스트 시나리오 */
    /* 1. Caclculator 인스턴스 생성이 잘 되는지 테스트 */
    /* @BeforeEach : @Test가 붙은 테스트 메소드 하나를 실행하기 전마다 실행되는 메소드 */
    @BeforeEach
    public void setup() {
    ...
    /* 2. sumTwoNumber 메서드가 정상 기능 하는지 테스트 */
    @Test
    ...
    public void sumTwoNumber_6과_7을_전달하면_합계가_13이_되는지_확인() {
        ...
        assertEquals(12, result, 1); //델타는 오차범위
    }

    /* @AfterAll : 모든 테스트 수행이 끝나고 호출 되는 메서드 */
    @AfterAll
