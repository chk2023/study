...
-- 메뉴 가격이 5000원을 초과하며 카테고리 코드가 10인 메뉴 조회
SELECT
	*
FROM
	tbl_menu
...
-- 메뉴 가격이 5000원을 초과하거나 카테고리 코드가 10인 메뉴 조회
SELECT
	*
FROM
	tbl_menu
...
-- (5) LIKE 연산자
-- '검색어%' : 검색어로 시작하는 단어, '%검색어' : 검색어로 끝나는 단어, '%검색어%' : 검색어를 포함한 단어
SELECT
	*
FROM
	tbl_menu
