-- 13. CONSTRAINTS (제약조건)
-- 테이블에 데이터가 입력 되거나 수정될 때의 규칙을 정의하며 데이터 무결성 보장에 도움이 된다.
...
VALUES
	(1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hong1234@gmail.com');
...
INSERT INTO 
	user_notnull (user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
	(3, 'user03', 'pass03', null, '여', '010-8765-4321', 'yoo123@gmail.com'); -- not null 제약조건 위반으로 삽입 불가
...
CREATE TABLE IF NOT EXISTS user_primarykey (
	user_no INT, -- PRIMARY KEY, 컬럼 레벨에 작성 -- NOT NULL UNIQUE = PRIMARY KEY
    user_id VARCHAR(255) NOT NULL,
    user_pwd VARCHAR(255) NOT NULL,
    user_name VARCHAR(255) NOT NULL,
    gender VARCHAR(3),
...
-- 4. FOREIGN KEY : 참조된 다른 테이블에서 제공하는 값만 사용할 수 있도록 하는 제약 조건
...
VALUES
	(1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hong1234@gmail.com', 10);
...
-- 첫 번째 테스트 자식 테이블 삭제 후 테스트하기
DROP TABLE IF EXISTS user_foreignkey1;

-- 삭제 룰을 별도로 적용하고 수행하면 삭제 가능. 자식 테이블의 값은 null로 변경 됨. 
DELETE FROM user_grade WHERE grade_code = 10;
...
-- 6. DEFAULT : 컬럼에 null 대신 기본 값을 적용할 수 있다.
...
VALUES
	('미국'); -- 지정되지 않은 컬럼에는 null 값이 아닌 default 값으로 insert 된다.
