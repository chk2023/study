...
![[Pasted image 20231017154011.png]]
명시적 초기화는 값이나 객체를 변수에 넣어주는 것.
초기화 블럭은 복잡한 초기화에 사용된다.
생성자는 iv를 초기화하고 복잡한 초기화를 하는 데 사용되는 메서드다. 

초기화에는 자동초기화, 간단초기화, 복잡초기화가 있다.
자동초기화는 인스턴스 변수가 타입에 따라 자동 초기화 되는 것.
간단초기화는 대입연산자로 초기화.
복잡초기화에는 {}, static{}, 생성자가 있다.
{}는 거의 사용하지 않고, static{}은 cv, 생성자는 iv를 초기화하는데 사용한다. 

![[Pasted image 20231017154429.png]]
cv가 먼저 초기화되고 iv가 초기화된다.