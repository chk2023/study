...
$idx = $_GET['idx'];
$query = "SELECT * FROM tMember WHERE idx = $idx";
$result = mysqli_query($connect, $query);
$modify = mysqli_fetch_array($result);
...
<body>
    ...
    <form method="POST" action="modify_ok.php?idx=<?php echo $idx; ?>" >
            ...
            <tr>
                <td bgcolor=white>
                    <table class="table2">
                        <tr>
                            <td>작성자</td>
                            <td><input type="text" name="name" size=30 placeholder="<? echo $modify['name']; ?>"></td>
                        </tr>
                        <tr>
                            <td>제목</td>
                            <td><input type="text" name="title" size=70 placeholder="<? echo $modify['title']; ?>"></td>
                        </tr>
                        <tr>
                            <td>내용</td>
                            <td><textarea name="content" cols=75 rows=15><? echo $modify['content']; ?></textarea></td>
                        </tr>
                        <tr>
                            <td>비밀번호</td>
